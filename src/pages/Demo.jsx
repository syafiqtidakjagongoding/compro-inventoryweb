        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-white mb-4">
              Lihat MyGudang Beraksi
            </h2>
            <p className="text-gray-400 text-lg">
              Jelajahi interface dan fitur-fitur unggulan kami
            </p>
          </div>
          ...
          {/* Demo Content */}
          <div
            className="bg-slate-900 rounded-xl border border-blue-500/20 overflow-hidden"
            id="demo"
          >
            {activeDemo === "dashboard" && (
              <div className="p-8">
                ...
                <div className="bg-slate-800/50 rounded-lg p-6 border border-blue-500/20">
                  ...
                  <div className="h-64 flex items-end justify-around gap-2">
                    {[65, 78, 52, 85, 70, 90, 75, 88, 95, 82, 70, 92].map(
                      (height, idx) => (
                        <div
                          key={idx}
                          className="flex-1 bg-linear-to-t from-blue-500 to-cyan-400 rounded-t opacity-80 hover:opacity-100 transition"
                          style={{ height: `${height}%` }}
                        ></div>
                      )
                    )}
